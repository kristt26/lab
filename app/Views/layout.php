                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="<?= session()->get('role') == 'Dosen' || session()->get('role') == 'Administrator' ?  base_url('assets/img/undraw_profile.svg'): base_url('assets/berkas/').session()->get('foto') ?>">
                                <?php if (session()->get('role') == 'Dosen' || session()->get('role') == 'Administrator') : ?>
